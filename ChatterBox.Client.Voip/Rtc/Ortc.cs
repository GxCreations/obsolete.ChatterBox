...
namespace ChatterBox.Client.Voip.Rtc
{
    ...
    using RtcRtpSender = org.ortc.RTCRtpSender;
    using RtcRtpReceiver = org.ortc.RTCRtpReceiver;
    using RtcOrtc = org.ortc.Ortc;
    using RtcOrtcWithDispatcher = org.ortc.OrtcWithDispatcher;
    using RtcLog = org.ortc.Log;
    using RtcLogger = org.ortc.Logger;
    ...
    using RtcConstrainStringParameters = org.ortc.ConstrainStringParameters;
    using RtcStringOrStringList = org.ortc.StringOrStringList;
    using RtcMediaStreamTrack = org.ortc.MediaStreamTrack;
    using RtcIceGatherer = org.ortc.RTCIceGatherer;
    using RtcIceTransport = org.ortc.RTCIceTransport;
    using RtcDtlsTransport = org.ortc.RTCDtlsTransport;
    using RtcDtlsParameters = org.ortc.RTCDtlsParameters;
    using RtcIceGatherOptions = org.ortc.RTCIceGatherOptions;
    using RtcIceServer = org.ortc.RTCIceServer;
    using RtcCertificate = org.ortc.RTCCertificate;
    using RtcIceGathererCandidateEvent = org.ortc.RTCIceGathererCandidateEvent;
    using RtcIceGathererCandidateCompleteEvent = org.ortc.RTCIceGathererCandidateCompleteEvent;
    ...
    using RtcRtpEncodingParameters = org.ortc.RTCRtpEncodingParameters;
    using RtcRtpHeaderExtensionParameters = org.ortc.RTCRtpHeaderExtensionParameters;
    using RtcRtcpParameters = org.ortc.RTCRtcpParameters;
    using RtcRtcpFeedback = org.ortc.RTCRtcpFeedback;
    using RtcRtpFecParameters = org.ortc.RTCRtpFecParameters;
    using RtcPriorityType = org.ortc.RTCPriorityType;
    using RtcRtpRtxParameters = org.ortc.RTCRtpRtxParameters;
...
#warning TODO IMPROVE ICE WIRING IceGatherer_OnICEGathererLocalCandidateGone
    ...
    internal sealed class MediaAudioTrack : IMediaStreamTrack, IDisposable
    {
        ...
        public string Kind { get { return _track.Kind.ToString(); } }
